<script>
 ...
 <div class="flex justify-center mt-16 lg:text-4xl md:text-2xl text-2xl dark:text-slate-50 font-semibold">Artificial Intelligence 🎨</div>
 <div class="max-w-screen-lg m-auto grid md:grid-cols-3 gap-6 mt-16 justify-center md:grid-cols-2 lg:grid-cols-3">  
        ...
        <Card href="/cards" class="col-span-1" >
            <img src="/src/routes/components/images/adobe-xd.png" alt="Figma" class="w-14 h-14">
        ...
        <Card href="https://www.adobe.com/products/photoshop.html" class="col-span-1" >
            <img src="/src/routes/components/images/photoshop.png" alt="Figma" class="w-14 h-14">
        ...
        <Card href="/cards" class="col-span-1" >
            <img src="/src/routes/components/images/canva.png" alt="Figma" class="w-14 h-14">
